        ...
        <header>
            <div id="outerContainer">
                ...
                <div id='topContainer'>
                    ...
                    <nuxt-link to='/'>
                        <div>DIY</div>
                        <!-- <img id='logo' src="img/ddiyLOGO.png" alt=""> -->
                        <!-- <image id='logo' alt="" src="/ddiyLOGO.png">DDIY</image> -->
                    </nuxt-link>
                    
                    <div id="helloContainer">
                        <template v-if="$auth.$state.loggedIn">
                            
                            <div id='firstName' ><div>Logged in as:</div><br><nuxt-link to='/profile'>{{ $auth.$state.user.businessName }}</nuxt-link></div>
                        </template>

                        <template v-else>    
                            <div id='login' class='unit1'><nuxt-link to="/login">Log In</nuxt-link></div>
                            <div id='signup' class='unit2'><nuxt-link to="/signup">Sign Up</nuxt-link></div>
                        </template>
                    </div>
                ...
                <div id="bottomContainer">
                    ...
                    <div id='features' class='linker'>
                        <nuxt-link to='/whyRun' style="white-space: pre;">Why fine painting?</nuxt-link>
                    </div>
                    ...
                    <div id='about' class='linker'>
                        <nuxt-link to='/profile'>My dogs</nuxt-link>
                    </div>
...
export default {
    methods: {
        showOptions() {
            ...
            let logoKFFirstMove = "@keyframes logoKFFirstMove                           { 0% { transform: translateX(0px) translateY(-19px) scale(1); } 20% { transform: translateX(0px) translateY(-19px) scale(1); } 85% { transform: translateX(-20px) translateY(-40px) scale(0.7); } 100% { transform: translateX(-20px) translateY(-40px) scale(0.7); } }";


            // login and signup chunk - move forward
            let loginAndSignupKFFirstMove = "@keyframes loginAndSignupKFFirstMove       { 0% { transform: translateY(0); } 50% { transform: translateY(-20px); } 100% { transform: translateY(-20px) ;} }";
            ...
            let logoKFSecondMove = "@keyframes logoKFSecondMove                         { 0% {transform: translateX(-20px) translateY(-40px) scale(0.7); } 15% {transform: translateX(-20px) translateY(-40px) scale(0.7);} 80% {transform: translateX(0px) translateY(-19px) scale(1);} 100% {transform: translateX(0px) translateY(-19px) scale(1);}}";
