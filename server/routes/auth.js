...
router.post("/auth/signup", async (req, res) => {
    if (!req.body.email || !req.body.password) { 
        ...
        try {
            ...
            newUser.businessEID = req.body.businessEID;

            newUser.email = req.body.email;
            newUser.password = req.body.password;
            newUser.streetAddress = req.body.streetAddress;
            newUser.cityAddress = req.body.cityAddress;
            newUser.zipCode = req.body.zipCode;
            newUser.cellNumber = req.body.cellNumber;
            newUser.landLine = req.body.landLine || "No landline provided.";
